...
func runNumberTest(
    c *qt.C, tests []testStep, tove func(interface{}) (interface{}, error), tov func(interface{}) interface{},
) {
    c.Helper()
...
func TestToTime(t *testing.T) {
    ...
    tests := []struct {
        ...
        {"2018-10-21T23:21:29+0200", time.Date(
            2018, 10, 21, 21, 21, 29, 0, time.UTC,
        ), false},                                                                           // RFC3339 without timezone hh:mm colon
        ...
        {"2016-03-06 15:28:01-0000", time.Date(
            2016, 3, 6, 15, 28, 1, 0, time.UTC,
        ), false}, // RFC3339 without T or timezone hh:mm colon
    ...
    for i, format := range timeFormats {
        ...
        t.Run(
            path.Join(nameBase), func(t *testing.T) {
                ...
                t.Run(
                    "local timezone without a default location", func(t *testing.T) {
                        c := qt.New(t)
                ...
                t.Run(
                    "nil default location", func(t *testing.T) {
                        c := qt.New(t)
                ...
                t.Run(
                    "default location not UTC", func(t *testing.T) {
                        c := qt.New(t)
                ...
                t.Run(
                    "time in the local timezone default location not UTC", func(t *testing.T) {
                        c := qt.New(t)
